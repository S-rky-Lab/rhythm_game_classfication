    ...
    <header className="border-b border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <div className="flex items-center gap-6">
          <Link href="/" className="flex items-center gap-2 text-lg font-bold text-indigo-600 dark:text-indigo-400 hover:opacity-90">
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
        ...
        <div className="flex items-center gap-3">
          ...
          {currentUser ? (
            <form action={logout}>
              <button
                type="submit"
                className="px-3 py-1.5 rounded-md text-sm font-medium border border-gray-300 dark:border-zinc-700 hover:bg-gray-100 dark:hover:bg-zinc-800 transition"
              >
                ログアウト
              </button>
            </form>
